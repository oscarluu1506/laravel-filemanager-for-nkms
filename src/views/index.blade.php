...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="vendor/laravel-filemanager/img/72px color.png">
  ...
  <link rel="stylesheet" href="/vendor/laravel-filemanager/css/mime-icons.min.css">
  <style>{!! \File::get(base_path('vendor/oscarluu1506/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('oscarluu1506.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
  ...
  <script>{!! \File::get(base_path('vendor/oscarluu1506/laravel-filemanager/public/js/script.js')) !!}</script>
