...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/oscarluu1506/laravel-filemanager-for-nkms/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/oscarluu1506/laravel-filemanager-for-nkms/public/js/script.js')) !!}</script>
